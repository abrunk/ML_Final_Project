...
Now that we have a clean data set, we have an opportunity to do some exploratory data analysis.  Next, we do a principle components analysis to further explore the data.
